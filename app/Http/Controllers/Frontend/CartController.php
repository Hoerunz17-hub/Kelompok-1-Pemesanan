...
class CartController extends Controller
{
    ...
    {
        // Order terakhir (untuk ambil name dari DB)
        // Kalau mau spesifik status pending, bisa diganti:
        ...
        return view('page.frontend.cart.index', compact('no_invoice', 'waiters', 'cart', 'order'));
    }
