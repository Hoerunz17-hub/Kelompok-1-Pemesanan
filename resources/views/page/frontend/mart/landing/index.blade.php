                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-vegetables-broccoli.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-bread-baguette.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Breads & Sweets</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-soft-drinks-bottle.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-wine-glass-bottle.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-animal-products-drumsticks.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-bread-herb-flour.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                            ...
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assetsfrontend/images/icon-vegetables-broccoli.png') }}images/"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                    ...
                    <div class="row">
                        <div class="col-md-6 p-5">
                            <div class="section-header">
                                <h2 class="section-title display-4">Get <span class="text-primary">50% Off</span> on your
                                    first 3 products</h2>
                            </div>
                            <p>Dapatkan potongan 50% untuk 3 produk pertama Anda dan mulai pengalaman manis bersama CakeMart
                            </p>
                        </div>
                    </div>
                                ...
                                <div
                                        ...
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-bananas.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-biscuits.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-cucumber.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-milk.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-orange-juice.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-raspberries.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-tomatoes.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assetsfrontend/images/thumb-tomatoketchup.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('assetsfrontend/images/blog-1.jpg') }}" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="post-header">
                                <h3 class="post-title">
                                    <a href="#" class="text-decoration-none">Tips Memilih Wedding Cake yang
                                        Sempurna untuk Hari Bahagiamu</a>
                                </h3>
                                <p>Pernikahan adalah momen spesial yang hanya terjadi sekali, dan wedding cake menjadi salah
                                    satu elemen penting yang tak boleh dilewatkan...</p>
                            </div>
                        </div>
                    </article>
                </div>
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('assetsfrontend/images/blog-2.jpg') }}" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="post-header">
                                <h3 class="post-title">
                                    <a href="#" class="text-decoration-none">Tren Kue Ulang Tahun 2025: Dari
                                        Minimalis hingga Fantasiy</a>
                                </h3>
                                <p>Ulang tahun selalu menjadi momen spesial, dan kue ulang tahun adalah pusat perhatian di
                                    setiap perayaan. Tahun 2025 menghadirkan tren...</p>
                            </div>
                        </div>
                    </article>
                </div>
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('assetsfrontend/images/blog-3.jpg') }}" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="post-header">
                                <h3 class="post-title">
                                    <a href="#" class="text-decoration-none">Cara Menyimpan dan Menghidangkan Kue
                                        Agar Tetap Segar dan Cantik</a>
                                </h3>
                                <p>Kue yang cantik dan lezat akan menjadi pusat perhatian di setiap acara. Agar kualitasnya
                                    tetap...</p>
                            </div>
                        </div>
                    </article>
