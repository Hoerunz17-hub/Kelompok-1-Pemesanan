                ...
                <div class="col-md-12">
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            ...
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assets/images/icon-bread-baguette.png') }}"
                                    alt="Category Thumbnail">
                            ...
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assets/images/icon-wine-glass-bottle.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                            ...
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="{{ asset('assets/images/icon-bread-herb-flour.png') }}"
                                    alt="Category Thumbnail">
                                <h3 class="category-title">Fruits & Veges</h3>
                            </a>
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assets/d-biscuits.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assets/d-cucumber.png') }}"
                                                        class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assets/d-milk.png') }}" class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                            <span class="qty">1 Unit</span><span class="rating"><svg
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="{{ asset('assets/d-bananas.png') }}" class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                            <span class="qty">1 Unit</span><span class="rating"><svg
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('assets/images/post-thumb-1.jpg') }}" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('assets/images/post-thumb-2.jpg') }}" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{ asset('assets/images/post-thumb-3.jpg') }}" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
