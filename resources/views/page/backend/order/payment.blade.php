                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($order->is_paid == 'paid')
                                        <span class="badge bg-success badge-large">PAID</span>
                                    @else
                                        <span class="badge bg-danger badge-large">UNPAID</span>
                                    @endif
                                </td>
                            </tr>
        ...
        <div class="col-lg-12 mt-3">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- ===================== PESAN SUDAH LUNAS ===================== --}}
                    @if ($order->is_paid == 'paid')
                        <div class="alert alert-success mt-3" style="font-weight:600;">
                            ✔️ Pembayaran Sudah Lunas
                        </div>
                    @endif
                    ...
                    {{-- ===================== PRINT BUTTON ===================== --}}
                    @if ($order->is_paid == 'paid')
                        <a href="{{ route('order.print', $order->id) }}" class="btn btn-success mt-3" target="_blank">
